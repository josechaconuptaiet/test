  ...
  return (
    <div style={{ padding: '40px', maxWidth: '1200px', margin: '0 auto', backgroundColor: '#fdfdfd' }}>
      ...
      <section style={{ marginBottom: '60px' }}>
        <h2 style={{ fontSize: '1.5rem', color: '#334155', marginBottom: '24px' }}>1. Input (Text Inputs)</h2>
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '24px', marginBottom: '40px' }}>
            <Input label="Grande (40px)" size="large" placeholder="Escribe algo..." prefix={<span>👤</span>} />
            <Input label="Mediano (32px - Por defecto)" size="medium" placeholder="Escribe algo..." prefix={<span>👤</span>} />
            <Input label="Pequeño (24px)" size="small" placeholder="Escribe algo..." prefix={<span>👤</span>} />
          </div>

          <h3 style={{ fontSize: '1.1rem', color: '#64748b', marginBottom: '16px' }}>1.2. Variantes</h3>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '24px', marginBottom: '40px' }}>
            <Input label="Delineado (Por defecto)" variant="outlined" placeholder="Borde completo" />
            <Input label="Relleno" variant="filled" placeholder="Fondo gris" />
            <Input label="Subrayado" variant="underlined" placeholder="Solo línea inferior" />
            <Input label="Sin bordes" variant="borderless" placeholder="Sin bordes ni fondo" />
          </div>

          <h3 style={{ fontSize: '1.1rem', color: '#64748b', marginBottom: '16px' }}>1.3. Colores y Tamaños Personalizados</h3>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '24px', marginBottom: '40px' }}>
            <Input label="Ancho Personalizado (200px)" width={200} placeholder="Ancho fijo" />
            <Input label="Color Verde Personalizado" color="#22c55e" placeholder="Foco verde" />
            <Input label="Naranja Personalizado y Grande" color="#f59e0b" size="large" placeholder="Naranja y grande" />
            <Input label="Rosa Personalizado y Subrayado" color="#ec4899" variant="underlined" placeholder="Rosa subrayado" />
          </div>

          <h3 style={{ fontSize: '1.1rem', color: '#64748b', marginBottom: '16px' }}>1.4. Estados</h3>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '24px', marginBottom: '40px' }}>
            <Input label="Estado de Error" status="error" errorMessage="Este campo tiene un error" prefix={<span>❌</span>} />
            <Input label="Estado de Advertencia" status="warning" errorMessage="Revisa los datos ingresados" prefix={<span>⚠️</span>} />
          </div>

          <h3 style={{ fontSize: '1.1rem', color: '#64748b', marginBottom: '16px' }}>1.5. Prefijos y Sufijos</h3>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '24px', marginBottom: '40px' }}>
            <Input label="Prefijo de Búsqueda" prefix={<span>🔍</span>} placeholder="Buscar..." />
            <Input label="Sufijo de Contraseña" type="password" suffix={<span>👁️</span>} placeholder="Contraseña" />
            <Input label="Ranura Doble" prefix={<span>💰</span>} suffix={<span>USD</span>} placeholder="Monto" />
          </div>
      ...
      <section style={{ marginBottom: '60px' }}>
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <Input label="Nombre Completo" placeholder="Ej: Juan Pérez" required name="modal-nombre" />
            <Input label="Correo Electrónico" type="email" placeholder="juan@ejemplo.com" required name="modal-email" />
            <Select
              label="Departamento"
              options={[
      ...
      <section style={{ marginTop: '100px', paddingBottom: '60px' }}>
        ...
        <div style={{ marginBottom: '60px' }}>
          <h3 style={{ fontSize: '1.4rem', color: '#334155', marginBottom: '20px' }}>Input</h3>
          <div style={{ overflowX: 'auto', backgroundColor: '#111827', borderRadius: '12px', padding: '1px' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', color: '#d1d5db', fontSize: '0.875rem', textAlign: 'left' }}>
              ...
              <tbody style={{ divideY: '1px solid #374151' }}>
                <tr style={{ borderTop: '1px solid #1f2937' }}><td style={{ padding: '16px', color: '#f3f4f6' }}>name</td><td style={{ padding: '16px' }}>Nombre único</td><td style={{ padding: '16px', color: '#818cf8' }}>string</td><td style={{ padding: '16px' }}>-</td></tr>
                <tr style={{ borderTop: '1px solid #1f2937' }}><td style={{ padding: '16px', color: '#f3f4f6' }}>label</td><td style={{ padding: '16px' }}>Etiqueta</td><td style={{ padding: '16px', color: '#818cf8' }}>string</td><td style={{ padding: '16px' }}>-</td></tr>
                <tr style={{ borderTop: '1px solid #1f2937' }}><td style={{ padding: '16px', color: '#f3f4f6' }}>type</td><td style={{ padding: '16px' }}>Tipo (text, password, etc)</td><td style={{ padding: '16px', color: '#818cf8' }}>string</td><td style={{ padding: '16px' }}>'text'</td></tr>
                <tr style={{ borderTop: '1px solid #1f2937' }}><td style={{ padding: '16px', color: '#f3f4f6' }}>width</td><td style={{ padding: '16px' }}>Ancho (px, %, etc)</td><td style={{ padding: '16px', color: '#818cf8' }}>string | number</td><td style={{ padding: '16px' }}>'100%'</td></tr>
                ...
                <tr style={{ borderTop: '1px solid #1f2937' }}><td style={{ padding: '16px', color: '#f3f4f6' }}>color</td><td style={{ padding: '16px' }}>Color principal</td><td style={{ padding: '16px', color: '#818cf8' }}>string</td><td style={{ padding: '16px' }}>'#6366f1'</td></tr>
                <tr style={{ borderTop: '1px solid #1f2937' }}><td style={{ padding: '16px', color: '#f3f4f6' }}>required</td><td style={{ padding: '16px' }}>Obligatorio</td><td style={{ padding: '16px', color: '#818cf8' }}>boolean</td><td style={{ padding: '16px' }}>false</td></tr>
                <tr style={{ borderTop: '1px solid #1f2937' }}><td style={{ padding: '16px', color: '#f3f4f6' }}>prefix / suffix</td><td style={{ padding: '16px' }}>Iconos o elementos</td><td style={{ padding: '16px', color: '#818cf8' }}>ReactNode</td><td style={{ padding: '16px' }}>-</td></tr>
                <tr style={{ borderTop: '1px solid #1f2937' }}><td style={{ padding: '16px', color: '#f3f4f6' }}>className / style</td><td style={{ padding: '16px' }}>Personalización CSS</td><td style={{ padding: '16px', color: '#818cf8' }}>string | object</td><td style={{ padding: '16px' }}>-</td></tr>
              </tbody>
            </table>
          </div>
        </div>
        ...
        <div style={{ marginBottom: '60px' }}>
          ...
          <div style={{ overflowX: 'auto', backgroundColor: '#111827', borderRadius: '12px', padding: '1px' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse', color: '#d1d5db', fontSize: '0.875rem', textAlign: 'left' }}>
              ...
              <tbody>
                <tr style={{ borderTop: '1px solid #1f2937' }}><td style={{ padding: '16px', color: '#f3f4f6' }}>options</td><td style={{ padding: '16px' }}>Lista de opciones</td><td style={{ padding: '16px', color: '#818cf8' }}>{'{value, label}'}[]</td><td style={{ padding: '16px' }}>[]</td></tr>
                <tr style={{ borderTop: '1px solid #1f2937' }}><td style={{ padding: '16px', color: '#f3f4f6' }}>width / height</td><td style={{ padding: '16px' }}>Dimensiones</td><td style={{ padding: '16px', color: '#818cf8' }}>string | number</td><td style={{ padding: '16px' }}>'100%' / -</td></tr>
                <tr style={{ borderTop: '1px solid #1f2937' }}><td style={{ padding: '16px', color: '#f3f4f6' }}>color</td><td style={{ padding: '16px' }}>Color de realce</td><td style={{ padding: '16px', color: '#818cf8' }}>string</td><td style={{ padding: '16px' }}>#6366f1</td></tr>
                <tr style={{ borderTop: '1px solid #1f2937' }}><td style={{ padding: '16px', color: '#f3f4f6' }}>multiple / searchable</td><td style={{ padding: '16px' }}>Funcionalidad extra</td><td style={{ padding: '16px', color: '#818cf8' }}>boolean</td><td style={{ padding: '16px' }}>false</td></tr>
                <tr style={{ borderTop: '1px solid #1f2937' }}><td style={{ padding: '16px', color: '#f3f4f6' }}>className / style</td><td style={{ padding: '16px' }}>Personalización CSS</td><td style={{ padding: '16px', color: '#818cf8' }}>string | object</td><td style={{ padding: '16px' }}>-</td></tr>
                <tr style={{ borderTop: '1px solid #1f2937' }}><td style={{ padding: '16px', color: '#f3f4f6' }}>required</td><td style={{ padding: '16px' }}>Obligatorio</td><td style={{ padding: '16px', color: '#818cf8' }}>boolean</td><td style={{ padding: '16px' }}>false</td></tr>
              </tbody>
            </table>
